...
@include('includes.Directeur.DirecteurSideBar.DirecteurSideBar')
    ...
    <div class="wrap-content">
        ...
        <form action="{{ route('responsable.register.process') }}" method="POST" class="category-form" enctype="multipart/form-data">

            <h1 class="permi-title">Enregistrement administrateur</h1><br/><br/>
